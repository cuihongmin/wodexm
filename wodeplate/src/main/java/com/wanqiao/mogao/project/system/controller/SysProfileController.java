...
import com.wanqiao.mogao.common.utils.file.FileUploadUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult updatePwd(String oldPassword, String newPassword)
    {
        try
        {
            oldPassword = MoGaoAES.getInstance().Decrypt(oldPassword);
            newPassword = MoGaoAES.getInstance().Decrypt(newPassword);
        }
        catch (Exception e)
        {
            e.printStackTrace();
            AjaxResult.error("AES解密密码失败");
        }
        LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws IOException
    {
        ...
        {
            LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
            String avatar = FileUploadUtils.upload(WanqiaoConfig.getAvatarPath(), file);
